...
class Leads extends Component{
  ...
  fetchLayout(){
    fetch(`${process.env.REACT_APP_API_URL}:${process.env.PORT_NUMBER}/api/leads/leadsbrowselayout/?page_size=100`, {
      method: 'GET',
  ...
  fetchData() {
    ...
    fetch(`${process.env.REACT_APP_API_URL}:${process.env.PORT_NUMBER}/api/leads${qs}`, {
      method: 'GET',
      headers: { 'Content-Type': 'application/json', 'Authorization':'Token '+sessionStorage.getItem("authUser").replace(/^"(.*)"$/, '$1')}
    })
    .then(res => res.json())
  ...
  deleteSelected = () => {
    ...
    fetch(`${process.env.REACT_APP_API_URL}:${process.env.PORT_NUMBER}/api/leads/delete-leads/`, {
      method: 'DELETE',
      headers: { 'Content-Type': 'application/json', 'Authorization':'Token '+sessionStorage.getItem("authUser").replace(/^"(.*)"$/, '$1')},
