...
import AddEditLead from "../pages/Leads/add-edit-lead";

import Contacts from "../pages/Contacts/index";
import AddEditContact from "../pages/Contacts/add-edit-contact";
...
const authProtectedRoutes = [
  ...
  { path: "/add-edit-lead", component: AddEditLead },

  // Contacts
  { path: "/contacts", component: Contacts },
  { path: "/add-edit-contact", component: AddEditContact },
  ...
  { path: "/", exact: true, component: () => <Redirect to="/leads" /> }
];
